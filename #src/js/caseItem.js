   ...
   if (data) {
      ...
      if (window.innerWidth > 767) {
         caseLinks[0].innerHTML = nextID
            ? `<a href="http://localhost:3000/portfolioitem.html?id:${nextID}" >&#8249; Предыдущий пациент</a>`
            : `<p class='link__inactive'>&#8249; Предыдущий пациент</p>`;
         caseLinks[1].innerHTML = previousID
            ? `<a href="http://localhost:3000/portfolioitem.html?id:${previousID}" class="cases-nav__link">Следующий пациент &#8250;</a>`
            : `<p class='link__inactive'>Следующий пациент &#8250;</p>`;
      } else {
         caseLinks[2].innerHTML = nextID
            ? `<div class='pacient__link left'><div>&#8249;</div><a href="http://localhost:3000/portfolioitem.html?id:${nextID}" >Предыдущий пациент</a></div>`
            : `<div class='pacient__link left'><div>&#8249;</div><p class='link__inactive'> Предыдущий пациент</p></div>`;
         caseLinks[3].innerHTML = previousID
            ? `<div class='pacient__link next'><a href="http://localhost:3000/portfolioitem.html?id:${previousID}" class="cases-nav__link">Следующий пациент </a><div>&#8250;</div></div>`
            : `<div class='pacient__link next'><p class='link__inactive'>Следующий пациент </p><div>&#8250;</div></div>`;
      }
      if (window.innerWidth > 767) {
      ...
      if (data.description && data.description !== 'undefined') {
         ...
         document.querySelector('.case-item__description_wrapper').style.display = 'none';
      }
